        ...
        <nav class="mt-2">
          ...
          <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item {{ request()->routeIs('salaires.*') ? 'menu-open' : '' }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a wire:navigate href="{{ route('etat.employes') }}"
                    class="nav-link {{ request()->routeIs('etat.employes') ? 'active' : '' }}">
                    <i class="nav-icon bi bi-circle"></i>
                ...
                <li class="nav-item">
                  <a wire:navigate href="{{ route('personnes.declares') }}"
                    class="nav-link {{ request()->routeIs('personnes.declares') ? 'active' : '' }}">
                    <i class="nav-icon bi bi-circle"></i>
